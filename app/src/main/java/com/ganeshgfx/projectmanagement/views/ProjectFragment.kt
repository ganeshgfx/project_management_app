...
class ProjectFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val  projectContainer =  (requireActivity() as MainActivity).appContainer.projectContainer

        if (projectContainer != null) {
            viewModel = ViewModelProvider(viewModelStore,projectContainer.projectViewModelFactory)[ProjectViewModel::class.java]
        }
